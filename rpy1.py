...
CTRL_QUEUE='resp_queue'
CTRL_RESPONSE_QUEUE='queue'
CTRL_ROUTING_KEY='resp_rk'
CTRL_RESPONSE_ROUTING_KEY='rk'
            ...
            with self.conn.channel() as self.channel:
                ...
                for message in self.queue.consume():
                    if message:
                        ...
                        dictr=json.loads(message.body)
                        print(dictr)
                        if float(dictr['Water Temperature']) >= 15 :
